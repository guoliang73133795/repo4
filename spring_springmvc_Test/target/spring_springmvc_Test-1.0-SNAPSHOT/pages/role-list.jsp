...
<link rel="stylesheet"
	...
	<script>
		function delRole(roleId) {
		    if(confirm("您确定要删除吗?")){
                location.href = "${pageContext.request.contextPath}/role/delRole/"+roleId;
			};
        };
	</script>
</head>
							...
							<div class="pull-left">
								<div class="form-group form-inline">
									<div class="btn-group">
										...
										<button type="button" class="btn btn-default" onclick="location.href='${pageContext.request.contextPath}/role/findAll'" title="刷新">
